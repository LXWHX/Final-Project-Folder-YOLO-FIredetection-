# -*- coding: utf-8 -*-
#load pyqt5 and model
#use tmp directory to store img detection result
# some part is borrowed form https://zhuanlan.zhihu.com/p/456550113
import shutil
import PyQt5.QtCore
...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/1825868.png"))
        # image read
        self.output_size = 480
        self.img2predict = ""
        self.device = '0' # changed to 0 (The first gpu)
        # video read
        self.vid_source = '0'  # The camera to use
        self.stopEvent = threading.Event()
        self.webcam = True
        self.stopEvent.clear()
        #The model's location
        self.model = self.model_load(weights="runs/train/expl/weights/best.pt",
                                     device=self.device)
        self.initUI()
        self.reset_vid()
    ...
    def initUI(self):
        ...
        # Two button upload and star scan
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("Image process")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()
        self.left_img = QLabel()
        self.right_img = QLabel()
        self.left_img.setPixmap(QPixmap("images/UI/upload.webp"))
        self.right_img.setPixmap(QPixmap("images/UI/upload.webp"))
        ...
        # Video detection arrange top-down format
        vid_detection_widget = QWidget()
        vid_detection_layout = QVBoxLayout()
        vid_title = QLabel("Video Detection")
        vid_title.setFont(font_title)
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/upload.webp"))
        ...
        self.addTab(vid_detection_widget, 'Vedio')
...
###########################################################################################################################
    ...
    def detect_img(self):
        ...
        imgsz = [1080, 1080]  # inference size (pixels)
        ...
        # print(source)
        if source == "":
            QMessageBox.warning(self, "Please upload", "Upload first and then detection")
        else:
            source = str(source)
...
#vedio close event
    ...
    # same as camera just the source is different
    def detect_vid(self):
        # pass
        model = self.model
        output_size = self.output_size
